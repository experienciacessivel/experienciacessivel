...
namespace experienciacessivel.infrastructure.data
{
    ...
    where TEntity : Entity
    {
        ...
        public virtual void Add(TEntity item)
        {
            ...
            else
            {
                LoggerFactory.CreateLog()
                          .LogInfo("Cannot add Null Entity", typeof(TEntity).ToString());
        ...
        public virtual void Remove(TEntity item)
        {
            ...
            {
                LoggerFactory.CreateLog()
                          .LogInfo("Cannot remove Null Entity", typeof(TEntity).ToString());
            }
        }
